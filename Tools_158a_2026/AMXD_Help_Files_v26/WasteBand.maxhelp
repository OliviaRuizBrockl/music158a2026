  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Hi_L -32, Low-Mid_L 4020, Mid_R -32, Mid_L -32, midOD_R 0, loOD_L 0, Low_L -32, hiOD_R 0, hiOD_L 0, Mid-Hi_L 4020, Low_R -32, Low-Mid_R 4020, Hi_R -32, loOD_R 0, midOD_L 0, Mid-Hi_R 4020, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "WasteBand — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-90",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Hi_L -70 6 float Low-Mid_L 40 8000 float Mid_R -70 6 float Mid_L -70 6 float midOD_R -100 100 float loOD_L -100 100 float Low_L -70 6 float hiOD_R -100 100 float hiOD_L -100 100 float Mid-Hi_L 40 8000 float Low_R -70 6 float Low-Mid_R 40 8000 float Hi_R -70 6 float loOD_R -100 100 float midOD_L -100 100 float Mid-Hi_R 40 8000 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_WasteBand",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
