  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "InputGain -3, ShiftGain -20, ShiftL 500, OutputGain 0, DelayR 1000, DelayL 1000, CombFeedback 49.5, MatrixClear 0.5, CombPitchL 60, DelayFeedback 49.5, DelayGain -20, CombPitchR 60, CombGain -20, ShiftR 500, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max EffectMatrix — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-82",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js ShiftGain -70 30 float ShiftL 0 1000 float DelayR 0 2000 float DelayL 0 2000 float CombFeedback 0 99 float MatrixClear 0 1 int CombPitchL 0 120 float DelayFeedback 0 99 float DelayGain -70 30 float CombPitchR 0 120 float CombGain -70 30 float ShiftR 0 1000 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_effectmatrix",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_effectmatrix"
    }
   },
   {
    "box": {
