  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "FilterFreqOffset 5025, EnvInput -3, EnvSharpness 0, EnvSmooth 250, FilterType 3.5, Dry/Wet 100, EnvInterval 252.5, FilterGain -20, FilterClear 0.5, EnvMode 0.5, FilterQ 5.05, FilterFreqRange 5000, EnvFollower 0.5, Gain 0, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max AutoFilter — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": 50,
         "maximum": 10000,
         "varname": "random_FilterFreqOffset"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 10000,
         "varname": "random_FilterFreqRange"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-80",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js FilterFreqOffset 50 10000 float EnvSharpness -1 1 float EnvSmooth 0 500 float FilterType 0 7 int EnvInterval 5 500 float FilterGain -70 30 float FilterClear 0 1 int EnvMode 0 1 int FilterQ 0.1 10 float FilterFreqRange 0 10000 float EnvFollower 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_autofilter",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
