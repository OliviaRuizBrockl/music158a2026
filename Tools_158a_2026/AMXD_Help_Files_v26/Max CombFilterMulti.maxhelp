  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Detune1 0, Pitch4 60, Dry/Wet 100, Detune5 0, Pitch1 60, Input -3, Feedfwd 49.5, Detune4 0, Pitch2 60, Feedback 49.5, Detune3 0, Pitch5 60, Tremolo 500, Gain 0, Detune2 0, Pitch3 60, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max CombFilterMulti — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-90",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Detune1 -50 50 float Pitch4 0 120 float Detune5 -50 50 float Pitch1 0 120 float Feedfwd 0 99 float Detune4 -50 50 float Pitch2 0 120 float Feedback 0 99 float Detune3 -50 50 float Pitch5 0 120 float Tremolo 0 1000 float Detune2 -50 50 float Pitch3 0 120 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_combfiltermulti",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_combfiltermulti"
    }
   },
   {
    "box": {
