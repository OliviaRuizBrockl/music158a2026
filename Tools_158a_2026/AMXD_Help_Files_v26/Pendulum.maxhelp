  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "spacing_right 5.5, wet_dry 100, \"delay left\" 500, master_window 500, phase_spread 0.125, frequency 10, spacing_left 5.5, freq_spread 0.125, window_spread 0.125, \"delay right\" 500, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Pendulum — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-60",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js spacing_right 1 10 float \"delay left\" 0 1000 float master_window 0 1000 float phase_spread 0 0.25 float frequency 0 20 float spacing_left 1 10 float freq_spread 0 0.25 float window_spread 0 0.25 float \"delay right\" 0 1000 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Pendulum",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
