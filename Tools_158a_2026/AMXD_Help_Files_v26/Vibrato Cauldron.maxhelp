  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "wet_dry 100, feedback 49.5, moddepth 25, delay 45, mod_cutoff 2000, mod_Q 99.5, rate 5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Vibrato Cauldron — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-45",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js feedback 0 99 float moddepth 0 50 float delay 0 90 float mod_cutoff 0 4000 float mod_Q 0 199 float rate 0 10 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_VibratoCauldron",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_VibratoCauldron"
    }
   },
   {
    "box": {
