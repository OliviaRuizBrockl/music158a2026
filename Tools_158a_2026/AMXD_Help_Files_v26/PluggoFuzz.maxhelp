  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "input_filter_gain 1.001, intensity 6, output_filter_frequency[1] 8010, input_filter_mode 3, output_filter_Q 10.005, clip_mode 1.5, output_filter_mode 3, level 0, output_filter_gain 1.001, input_filter_Q 10.005, input_filter_frequency 8010, input_gain -3, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "PluggoFuzz — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": 0.001,
         "maximum": 2,
         "varname": "random_input_filter_gain"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 20,
         "maximum": 16000,
         "varname": "random_output_filter_frequency_1_"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 6,
         "varname": "random_input_filter_mode"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0.01,
         "maximum": 20,
         "varname": "random_output_filter_Q"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 6,
         "varname": "random_output_filter_mode"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0.001,
         "maximum": 2,
         "varname": "random_output_filter_gain"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 20,
         "maximum": 16000,
         "varname": "random_input_filter_frequency"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-70",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js input_filter_gain 0.001 2 float intensity 1 11 float output_filter_frequency[1] 20 16000 float input_filter_mode 0 6 int output_filter_Q 0.01 20 float clip_mode 0 3 int output_filter_mode 0 6 int output_filter_gain 0.001 2 float input_filter_Q 0.01 20 float input_filter_frequency 20 16000 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_PluggoFuzz",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
