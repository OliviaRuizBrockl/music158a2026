  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "LowXFreq 5025, EffectGain 0, HighDelL 1000, MidFB 49.5, LowEnable 0.5, LowDelR 1000, HighEnable 0.5, HighGain -20, MidDelR 1000, HighXFreq 5025, MidGain -20, HighDelR 1000, MidDelL 1000, LowDelL 1000, HighFB 49.5, MidEnable 0.5, DirectGain -70, Lowgain -20, LowFB 49.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max DelayMultiBand — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-105",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js LowXFreq 50 10000 float HighDelL 0 2000 float MidFB 0 99 float LowEnable 0 1 int LowDelR 0 2000 float HighEnable 0 1 int HighGain -70 30 float MidDelR 0 2000 float HighXFreq 50 10000 float MidGain -70 30 float HighDelR 0 2000 float MidDelL 0 2000 float LowDelL 0 2000 float HighFB 0 99 float MidEnable 0 1 int Lowgain -70 30 float LowFB 0 99 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_delaymultiband",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_delaymultiband"
    }
   },
   {
    "box": {
