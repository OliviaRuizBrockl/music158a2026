  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "T2_depth 50, wet_dry_level 100, T1_mod_freq 1, T3_mod_freq 1, T4_mod_freq 1, T1_delay 50, T3_delay 50, T4_delay 50, waveform 0.5, T2_mod_freq 1, level 0, T4_depth 50, T2_delay 50, T1_depth 50, T3_depth 50, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Warpoon — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-85",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js T2_depth 0 100 float T1_mod_freq 0 2 float T3_mod_freq 0 2 float T4_mod_freq 0 2 float T1_delay 0 100 float T3_delay 0 100 float T4_delay 0 100 float waveform 0 1 int T2_mod_freq 0 2 float T4_depth 0 100 float T2_delay 0 100 float T1_depth 0 100 float T3_depth 0 100 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Warpoon",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
