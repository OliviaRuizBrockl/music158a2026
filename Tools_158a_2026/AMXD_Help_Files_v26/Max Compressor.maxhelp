  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Mode 0.5, LevelDetectGating -45, Range 18, SideChainFilter 0.5, ProgressiveRelease 50, AGC 0.5, Delay 50, Preset 2, ChannelCoupling 1, Release 75, Meters 0.5, Gain 0, Attack 75, DownExpandThresh -45, DownExpandEnable 0.5, DualBand 0.5, Ratio 50, Limiter 0.5, SmoothGain 50, MetersRate 125, Bypass 0.5, LevelDetectFreeze -45, Thresh -18, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max Compressor — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": -90,
         "maximum": 0,
         "varname": "random_LevelDetectGating"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 1,
         "varname": "random_SideChainFilter"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 100,
         "varname": "random_ProgressiveRelease"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 2,
         "varname": "random_ChannelCoupling"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": -90,
         "maximum": 0,
         "varname": "random_DownExpandThresh"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 1,
         "varname": "random_DownExpandEnable"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": -90,
         "maximum": 0,
         "varname": "random_LevelDetectFreeze"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-125",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Mode 0 1 int LevelDetectGating -90 0 int Range 0 36 int SideChainFilter 0 1 int ProgressiveRelease 0 100 int AGC 0 1 int Delay 0 100 int Preset 0 4 int ChannelCoupling 0 2 int Release 0 150 int Meters 0 1 int Attack 0 150 int DownExpandThresh -90 0 int DownExpandEnable 0 1 int DualBand 0 1 int Ratio 0 100 int Limiter 0 1 int SmoothGain 0 100 int MetersRate 0 250 float Bypass 0 1 int LevelDetectFreeze -90 0 int Thresh -36 0 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_compressor",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
