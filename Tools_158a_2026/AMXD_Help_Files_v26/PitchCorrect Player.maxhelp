  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Loop 0.5, Quality 1, Correct 0.5, ZoomV 0.5, Rev 0.5, ZoomInit 0.5, Fade 500, SelectAll 0.5, Choose 0.5, Slur 500, Sync 0.5, Thru 0, Formant 0.5, Pitch 0.5, Tuning 450, Play 0.5, Gain 0, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "PitchCorrect Player — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-100",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Loop 0 1 int Quality 0 2 int Correct 0 1 int ZoomV 0 1 float Rev 0 1 int ZoomInit 0 1 int Fade 0 1000 float SelectAll 0 1 int Choose 0 1 int Slur 0 1000 float Sync 0 1 int Formant 0 1 int Pitch 0 1 int Tuning 400 500 float Play 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_PitchCorrectPlayer",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_PitchCorrectPlayer"
    }
   },
   {
    "box": {
