  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Dry/Wet 100, DelayRange 2500, FeedbackRandStep 129, DelayRandStep 129, FeedbackRange 49.5, FeedbackRand 0.5, DelayRand 0.5, Gain 0, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max SpectralDelay — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": 2,
         "maximum": 256,
         "varname": "random_FeedbackRandStep"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-53",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js DelayRange 0 5000 float FeedbackRandStep 2 256 int DelayRandStep 2 256 int FeedbackRange 0 99 float FeedbackRand 0 1 int DelayRand 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_spectraldelay",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_spectraldelay"
    }
   },
   {
    "box": {
