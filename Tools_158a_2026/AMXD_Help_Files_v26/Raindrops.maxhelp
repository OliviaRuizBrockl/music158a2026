  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "max_freq 10000.5, wet/dry 100, min_freq 10000.5, resonance 100, density 500, attack 500, gain_overdrive 0.5, decay 500, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Raindrops — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-50",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js max_freq 1 20000 float min_freq 1 20000 float resonance 0 200 float density 0 1000 float attack 0 1000 float gain_overdrive 0 1 float decay 0 1000 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Raindrops",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
