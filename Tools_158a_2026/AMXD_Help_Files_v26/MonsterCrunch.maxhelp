  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "lowpass-resonance 0.495, low-freq-depth 100, \"Initial Gain\" 180, hi-freq-offset 0.5, wet-dry 100, filter-cutoff 2000, low-freq-offset 0.5, level 0, hi-mod-freq 50, hi-freq-depth 100, low-mod-freq 50, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "MonsterCrunch — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 0.99,
         "varname": "random_lowpass_resonance"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 1,
         "varname": "random_low_freq_offset"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-65",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js lowpass-resonance 0 0.99 float low-freq-depth 0 200 int \"Initial Gain\" 0 360 float hi-freq-offset 0 1 float filter-cutoff 0 4000 float low-freq-offset 0 1 float hi-mod-freq 0 100 float hi-freq-depth 0 200 int low-mod-freq 0 100 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_MonsterCrunch",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_MonsterCrunch"
    }
   },
   {
    "box": {
