  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "feedback_gain 0, ff_mod_depth 50, wet/dry 100, fb_mod_depth 50, feedback 50, ff_mod_freq 25, fb_mod_freq 25, feedforward 50, Feedforward 0, input_gain -3, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Generic Effect — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-60",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js feedback_gain -1 1 float ff_mod_depth 0 100 float fb_mod_depth 0 100 float feedback 0 100 float ff_mod_freq 0 50 float fb_mod_freq 0 50 float feedforward 0 100 float Feedforward -1 1 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_GenericEffect",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_GenericEffect"
    }
   },
   {
    "box": {
