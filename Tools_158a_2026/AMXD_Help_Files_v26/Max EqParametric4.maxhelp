  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Gain[4] -20, Q[3] 5.05, Active[2] 0.5, Freq[1] 9025, Freq[4] 9025, Type[3] 4, Gain[2] -20, Q[1] 5.05, MasterGain 0, Q[4] 5.05, Active[3] 0.5, Freq[2] 9025, Type[1] 4, FilterClear 0.5, Type[4] 4, Gain[3] -20, Q[2] 5.05, Active[1] 0.5, Active[4] 0.5, Freq[3] 9025, Reset 0.5, Type[2] 4, Gain[1] -20, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max EqParametric4 — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-125",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Gain[4] -70 30 float Q[3] 0.1 10 float Active[2] 0 1 int Freq[1] 50 18000 float Freq[4] 50 18000 float Type[3] 0 8 int Gain[2] -70 30 float Q[1] 0.1 10 float Q[4] 0.1 10 float Active[3] 0 1 int Freq[2] 50 18000 float Type[1] 0 8 int FilterClear 0 1 int Type[4] 0 8 int Gain[3] -70 30 float Q[2] 0.1 10 float Active[1] 0 1 int Active[4] 0 1 int Freq[3] 50 18000 float Reset 0 1 int Type[2] 0 8 int Gain[1] -70 30 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_EqParametric4",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_EqParametric4"
    }
   },
   {
    "box": {
