  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Portamento 50, sync 0.5, wet_dry 100, note_length 10.5, defaultPitch 0.5, auto_trig 0.5, reverse 1, trigger 0.5, density 50, stutters 37, left_freeze 0.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Stutterer — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-71",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Portamento 0 100 int sync 0 1 int note_length 0 21 int defaultPitch 0 1 int auto_trig 0 1 int reverse 0 2 int trigger 0 1 int density 0 100 int stutters 0 74 int left_freeze 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Stutterer",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
