  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "left_speed 0, left_length 1000, wet/dry 100, right_speed 0, left_feedback 50, feedback_clipping 50, right_length 1000, right_feedback 50, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Speed Shifter — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 100,
         "varname": "random_feedback_clipping"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-50",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js left_speed -400 400 float left_length 0 2000 float right_speed -400 400 float left_feedback 0 100 float feedback_clipping 0 100 float right_length 0 2000 float right_feedback 0 100 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_SpeedShifter",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_SpeedShifter"
    }
   },
   {
    "box": {
