  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "ModeR 0.5, ShiftL 0, DelayR 1250, Dry/Wet 100, BeatL 3.5, DelayL 1250, DetuneR 0, PanR 0, TranspL 0, BeatR 3.5, Feedback 49.5, DetuneL 0, PanL 0, Gain 0, TranspR 0, ModeL 0.5, ShiftR 0, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max SpectralHarm — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-95",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js ModeR 0 1 int ShiftL -200 200 float DelayR 0 2500 float BeatL 0 7 float DelayL 0 2500 float DetuneR -50 50 int PanR -50 50 float TranspL -24 24 int BeatR 0 7 float Feedback 0 99 float DetuneL -50 50 int PanL -50 50 float TranspR -24 24 int ModeL 0 1 int ShiftR -200 200 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_spectralharm",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_spectralharm"
    }
   },
   {
    "box": {
