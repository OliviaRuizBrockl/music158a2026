  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "modIn-3 78.5, modIn-1 78.5, RandSmooth 0.5, wet/dry 1, FB-level 50, modIn-4 78.5, AFB-Sens 50, GL-Delay 50, GL-Freq 50, modIn-5 78.5, AFB-Rate 50, modIn-2 78.5, AutoNetRate 50, Auto-FB 0.5, randTrig 0.5, GL-Q 50, AFB-Clip 50, FB-Gain 50, AutoGainRate 50, AutoRandNetwork 0.5, RandInLevels 0.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Feedback Network — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 1,
         "varname": "random_AutoRandNetwork"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-117",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js modIn-3 0 157 float modIn-1 0 157 float RandSmooth 0 1 int FB-level 0 100 float modIn-4 0 157 float AFB-Sens 0 100 float GL-Delay 0 100 float GL-Freq 0 100 float modIn-5 0 157 float AFB-Rate 0 100 float modIn-2 0 157 float AutoNetRate 0 100 float Auto-FB 0 1 int randTrig 0 1 int GL-Q 0 100 float AFB-Clip 0 100 float FB-Gain 0 100 float AutoGainRate 0 100 float AutoRandNetwork 0 1 int RandInLevels 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_FeedbackNetwork",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_FeedbackNetwork"
    }
   },
   {
    "box": {
