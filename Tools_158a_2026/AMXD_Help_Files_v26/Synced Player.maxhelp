  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Beats 127.5, Warp 0.5, ResetPitchTime 0.5, EnableTransp 0.5, Quality 1.5, ZoomV 0.5, Quantize 6.5, Rev 0.5, StretchMode 0.5, ZoomInit 0.5, Fade 500, SelectAll 0.5, Choose 0.5, Stretch 3.5, Thru 0, EnableFormant 0.5, Formant 0, Mode 2.5, Play 0.5, QuantizeLed 0.5, Gain 0, Transp 0, Bars 127.5, ResetLength 0.5, Grid 16.5, EnableStretch 0.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Synced Player — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-145",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Beats 0 255 int Warp 0 1 int ResetPitchTime 0 1 int EnableTransp 0 1 int Quality 0 3 int ZoomV 0 1 float Quantize 0 13 int Rev 0 1 int StretchMode 0 1 int ZoomInit 0 1 int Fade 0 1000 float SelectAll 0 1 int Choose 0 1 int Stretch 0 7 int EnableFormant 0 1 int Formant -1200 1200 int Mode 0 5 int Play 0 1 int QuantizeLed 0 1 int Transp -2400 2400 float Bars 0 255 int ResetLength 0 1 int Grid 1 32 int EnableStretch 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_SyncedPlayer",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_SyncedPlayer"
    }
   },
   {
    "box": {
