  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "VibDepth 600, VibOscAmount 50, Quality 1.5, Latency 0.5, VibDirection 1, VibOscEnable 0.5, Glide 5000, VibEnable 0.5, VibRate 50, VibNoiseAmount 50, Gain 0, Transp 0, Dry/Wet 100, VibNoiseEnable 0.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Pitch & Vibrato — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-80",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js VibDepth 0 1200 float VibOscAmount 0 100 float Quality 0 3 int Latency 0 1 int VibDirection 0 2 int VibOscEnable 0 1 int Glide 0 10000 float VibEnable 0 1 int VibRate 0 100 float VibNoiseAmount 0 100 float Transp -2400 2400 float VibNoiseEnable 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_PitchVibrato",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_PitchVibrato"
    }
   },
   {
    "box": {
