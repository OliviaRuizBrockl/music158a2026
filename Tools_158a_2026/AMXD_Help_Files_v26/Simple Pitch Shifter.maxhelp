  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Quality 1.5, Latency 0.5, Glide 5000, Gain 0, Transp 0, Dry/Wet 100, Final_Output_Gain -65.",
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Simple Pitch Shifter — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-40",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Quality 0 3 int Latency 0 1 int Glide 0 10000 float Transp -2400 2400 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_SimplePitchShifter",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_SimplePitchShifter"
    }
   },
   {
    "box": {
