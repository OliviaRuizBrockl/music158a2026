  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "pitch_rand 127.5, wet_dry 100, window 256, scan_rate 256, mod.speed 256, mode.offset 0.5, grain 250, mode.freeze 0.5, speed 258.5, pitch 256, xfade 250, mod.amount 256, live.button 0.5, mess 0.5, rnd_stereo 256, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Wheat — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-88",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js pitch_rand 0 255 int window 0 512 float scan_rate 0 512 float mod.speed 0 512 float mode.offset 0 1 int grain 0 500 float mode.freeze 0 1 int speed 5 512 float pitch 0 512 float xfade 0 500 float mod.amount 0 512 float live.button 0 1 int mess 0 1 int rnd_stereo 0 512 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Wheat",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
