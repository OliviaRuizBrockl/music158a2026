  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "InGain -3, SynthGain -23, Bus 5.5, Latency 0.5, TimeThresh 500, 16bit 0.5, MinVel 127.5, Waveform 1.5, Channel 1, Smooth 250, Tracking 0.5, Gain 0, Flush 0.5, Midi 0.5, Dry/Wet 100, Synth 0.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Pitch Tracker — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-90",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js SynthGain -70 24 float Bus 0 11 int Latency 0 1 int TimeThresh 0 1000 float 16bit 0 1 int MinVel 0 255 int Waveform 0 3 int Channel 0 2 int Smooth 0 500 float Tracking 0 1 int Flush 0 1 int Midi 0 1 int Synth 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_PitchTracker",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_PitchTracker"
    }
   },
   {
    "box": {
