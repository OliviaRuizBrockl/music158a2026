  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "PositionMode 0.5, Activate 0.5, PositionFree 50, RateUnit 10, RateRand 50, Output 0, DistanceMax 100.5, Source -3, DistanceMin 50.5, RateMult 50.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max DopplerPan — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-60",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js PositionMode 0 1 int Activate 0 1 int PositionFree 0 100 float RateUnit 0 20 int RateRand 0 100 float DistanceMax 1 200 float DistanceMin 1 100 float RateMult 1 100 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_dopplerpan",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
