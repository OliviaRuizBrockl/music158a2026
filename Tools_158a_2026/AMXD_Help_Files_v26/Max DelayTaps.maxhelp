  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "LevelsDistr 0, PansMax 0, DelaysMin 2500, LevelsShape 0, PansDistr 0, PansMin 0, Dry/Wet 100, DelaysShape 0, MasterGain 0, LevelsMax 50, Feedback 49.5, Taps 17, DelaysDistr 0, LevelsMin 50, DelaysMax 2500, PansShape 0, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max DelayTaps — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-94",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js LevelsDistr -1 1 float PansMax -50 50 float DelaysMin 0 5000 float LevelsShape -1 1 float PansDistr -1 1 float PansMin -50 50 float DelaysShape -1 1 float LevelsMax 0 100 float Feedback 0 99 float Taps 2 32 int DelaysDistr -1 1 float LevelsMin 0 100 float DelaysMax 0 5000 float PansShape -1 1 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_delaytaps",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
