  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "AmbienceThreshold 0, SnapToGrid 0.5, Quality 1.5, Latency 0.5, CorrectionAmount 50, Tonic 5.5, InitScale 0.5, CorrectionThreshold 49.5, Points 129, InitSettings 0.5, GridResol 128.5, Pattern 5.5, Gain 0, Dry/Wet 100, SibilanceThreshold 250, Import 0.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Microtuner — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-93",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js AmbienceThreshold -10 10 float SnapToGrid 0 1 int Quality 0 3 int Latency 0 1 int CorrectionAmount 0 100 int Tonic 0 11 int InitScale 0 1 int CorrectionThreshold 0 99 int Points 2 256 int InitSettings 0 1 int GridResol 1 256 int Pattern 0 11 int SibilanceThreshold 0 500 float Import 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Microtuner",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
