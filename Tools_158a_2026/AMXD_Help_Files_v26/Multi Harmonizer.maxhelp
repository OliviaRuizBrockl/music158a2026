  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Atten 0.5, VibDepth 600, VibOscAmount 50, Bus 5.5, Quality 1.5, Latency 0.5, PreGain -20, VibDirection 1, VibOscEnable 0.5, Fade 5000, Shift 0, VibEnable 0.5, VibRate 50, Spread 50, VibNoiseAmount 50, Pattern 4.5, Gain 0, Midi 0.5, Dry/Wet 100, Clear 0.5, VibNoiseEnable 0.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Multi Harmonizer — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-118",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Atten 0 1 int VibDepth 0 1200 float VibOscAmount 0 100 float Bus 0 11 int Quality 0 3 int Latency 0 1 int PreGain -70 30 float VibDirection 0 2 int VibOscEnable 0 1 int Fade 0 10000 float Shift -1200 1200 float VibEnable 0 1 int VibRate 0 100 float Spread 0 100 float VibNoiseAmount 0 100 float Pattern 0 9 int Midi 0 1 int Clear 0 1 int VibNoiseEnable 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_MultiHarmonizer",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_MultiHarmonizer"
    }
   },
   {
    "box": {
