  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "wet_dry 100, delay_range 0.5, scalling_mode 0.5, input_curve 5, delay 50, drive 21.05, averaging_mode 1, factor 50, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Mangle Filter — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-50",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js delay_range 0 1 int scalling_mode 0 1 int input_curve 2 8 float delay 0 100 float drive 0.1 42 float averaging_mode 0 2 int factor 0 100 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_MangleFilter",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_MangleFilter"
    }
   },
   {
    "box": {
