  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "grain-xfade 500.5, fb-delay 2500.5, grain-duration 2500.5, grain-pitch 0, wet/dry 100, stereo-factor 0, grain-period 2502.5, fb-amount 350, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Rye — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-50",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js grain-xfade 1 1000 float fb-delay 1 5000 float grain-duration 1 5000 float grain-pitch -10 10 float stereo-factor -3 3 float grain-period 5 5000 float fb-amount 0 700 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Rye",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
