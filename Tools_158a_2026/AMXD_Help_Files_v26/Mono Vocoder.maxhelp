  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "AmbienceThreshold 0, Bus 5.5, Quality 1.5, Detune 0, Latency 0.5, CorrectionAmount 50, Glide 5000, CorrectionThreshold 49.5, InitSettings 0.5, Pitch 127.5, Gain 0, Midi 0.5, Dry/Wet 100, SibilanceThreshold 250, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Mono Vocoder — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-80",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js AmbienceThreshold -10 10 float Bus 0 11 int Quality 0 3 int Detune -100 100 float Latency 0 1 int CorrectionAmount 0 100 int Glide 0 10000 float CorrectionThreshold 0 99 int InitSettings 0 1 int Pitch 0 255 int Midi 0 1 int SibilanceThreshold 0 500 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_MonoVocoder",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
