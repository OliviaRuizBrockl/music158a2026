  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "noise_gainR 3.5, noise_gainL 3.5, noise_Q_R 40.25, wet_dry_left 100, link 0.5, noise_out_gain_L 600, noise_CF_R 2000, noise_Q_L 40.25, noise_out_gain_R 600, noise_CF_L 2000, wet_dry_right 100, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Noyzckippr — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 1200,
         "varname": "random_noise_out_gain_L"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 1200,
         "varname": "random_noise_out_gain_R"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-65",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js noise_gainR 0 7 float noise_gainL 0 7 float noise_Q_R 0.5 80 float link 0 1 int noise_out_gain_L 0 1200 float noise_CF_R 0 4000 float noise_Q_L 0.5 80 float noise_out_gain_R 0 1200 float noise_CF_L 0 4000 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Noyzckippr",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
