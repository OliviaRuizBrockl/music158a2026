  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "\"buffer size\" 5520.5, direction 0.5, \"drop out\" 0.5, \"amp variation\" 0.5, declick 0.5, repetition 50, \"Playback Speed\" 2, feedback 0.495, wet_dry 100, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Fragulator — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-55",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js \"buffer size\" 16 11025 float direction 0 1 int \"drop out\" 0 1 float \"amp variation\" 0 1 float declick 0 1 int repetition 0 100 int \"Playback Speed\" 0 4 int feedback 0 0.99 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Fragulator",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
