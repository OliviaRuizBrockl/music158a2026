  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "Atten 0.5, AmbienceThreshold 0, Bus 5.5, Quality 1.5, Latency 0.5, PreGain -20, CorrectionAmount 50, Fade 5000, Shift 0, CorrectionThreshold 49.5, InitSettings 0.5, Spread 50, Pattern 4.5, Gain 0, Midi 0.5, Dry/Wet 100, Clear 0.5, SibilanceThreshold 250, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Poly Vocoder — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": -10,
         "maximum": 10,
         "varname": "random_AmbienceThreshold"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 100,
         "varname": "random_CorrectionAmount"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 99,
         "varname": "random_CorrectionThreshold"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 500,
         "varname": "random_SibilanceThreshold"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-103",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js Atten 0 1 int AmbienceThreshold -10 10 float Bus 0 11 int Quality 0 3 int Latency 0 1 int PreGain -70 30 float CorrectionAmount 0 100 int Fade 0 10000 float Shift -1200 1200 float CorrectionThreshold 0 99 int InitSettings 0 1 int Spread 0 100 float Pattern 0 9 int Midi 0 1 int Clear 0 1 int SibilanceThreshold 0 500 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_PolyVocoder",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
