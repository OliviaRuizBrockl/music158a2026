  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "playback_speed 5.001, grain_range 5513, range 127.5, active_left 0.5, grain_size 5513, playback_speed_range 5, wet_dry 100, pulse_range 500, active_right 0.5, pulse_offset 502.5, min_amp 127.5, density 50, randomize 0.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Granular-to-go — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         ...
         "minimum": 0,
         "maximum": 10,
         "varname": "random_playback_speed_range"
        }
       },
       {
        "box": {
       ...
       },
       {
        "box": {
         "id": "obj-75",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js playback_speed 0.001 10 int grain_range 1 11025 float range 0 255 int active_left 0 1 int grain_size 1 11025 float playback_speed_range 0 10 int pulse_range 0 1000 float active_right 0 1 int pulse_offset 5 1000 float min_amp 0 255 int density 0 100 int randomize 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Granulartogo",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_Granulartogo"
    }
   },
   {
    "box": {
