  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "EnvInput -3, EnvSharpness 0, EnvSmooth 250, Dry/Wet 100, EnvInterval 252.5, ModRange 5000, EnvMode 0.5, ModOffset 5000, EnvFollower 0.5, Gain 0, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max AutoRingMod — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-60",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js EnvSharpness -1 1 float EnvSmooth 0 500 float EnvInterval 5 500 float ModRange 0 10000 float EnvMode 0 1 int ModOffset 0 10000 float EnvFollower 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_autoringmod",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
