  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "step_len 10.5, wet/dry 100, steps 127.5, bpm 165, reset 0.5, tempo 0.5, glide 127.5, step_type[1] 0.5, view 0.5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Flange-o-tron — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-58",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js step_len 0 21 int steps 0 255 int bpm 30 300 float reset 0 1 int tempo 0 1 int glide 0 255 int step_type[1] 0 1 int view 0 1 int",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_Flangeotron",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
