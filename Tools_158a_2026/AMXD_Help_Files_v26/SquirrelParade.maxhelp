  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "dropout 0.5, fmd4 5, bs_4 5, freq 1000, wet/dry 100, grain_size 48002, v2 0.5, spread 50, window 0.5, v3 0.5, repeat 0.5, v4 0.5, fmd3 5, bs_3 5, fmd2 5, bs_2 5, test_01 0.5, v1 0.5, fmd1 5, bs_1 5, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "SquirrelParade — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-127",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js dropout 0 1 float fmd4 0 10 float bs_4 0 10 float freq 0 2000 float grain_size 4 96000 float v2 0 1 float spread 0 100 float window 0 1 float v3 0 1 float repeat 0 1 float v4 0 1 float fmd3 0 10 float bs_3 0 10 float fmd2 0 10 float bs_2 0 10 float test_01 0 1 int v1 0 1 float fmd1 0 10 float bs_1 0 10 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_SquirrelParade",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     ...
     "text": "receive~ AMXD_SquirrelParade"
    }
   },
   {
    "box": {
