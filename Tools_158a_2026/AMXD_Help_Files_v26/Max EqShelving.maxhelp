  ...
  "boxes": [
   ...
   },
   {
    "box": {
     "id": "obj-93",
     "maxclass": "message",
     "text": "LowXFreq 5025, LowEnable 0.5, MasterGain 0, HighEnable 0.5, HighGain -20, HighXFreq 5025, MidGain -20, MidEnable 0.5, Lowgain -20, Final_Output_Gain -65.",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
      ""
      ...
      "boxes": [
       {
        "box": {
         "id": "obj-1",
         "maxclass": "comment",
         "text": "Max EqShelving — Direct_Parameter_Messaging / Dynamic Tuning",
         "fontsize": 18,
         "fontface": 1,
         "patching_rect": [
          24,
       ...
       },
       {
        "box": {
         "id": "obj-55",
         "maxclass": "newobj",
         "text": "js amxd_randomize_direct_parameters.js LowXFreq 50 10000 float LowEnable 0 1 int HighEnable 0 1 int HighGain -70 30 float HighXFreq 50 10000 float MidGain -70 30 float MidEnable 0 1 int Lowgain -70 30 float",
         "numinlets": 1,
         "numoutlets": 1,
         "outlettype": [
          ""
   ...
   },
   {
    "box": {
     ...
     "hint": "External signal input: send~ AMXD_EqShelving",
     "id": "obj-115",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
