    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_sub",
          "maxclass": "comment",
          "text": "Stereo low-frequency oscillator",
          "fontsize": 13,
          "fontface": 1,
          "patching_rect": [
            24,
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Generates paired left/right LFO signals with controllable phase, duty, waveform and independent spin behavior.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_stereolfo",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.dsp.stereolfo~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js duty:random waveform:random phase:random stereophase:random spin:random enablespin:random",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js duty waveform phase stereophase spin enablespin",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.dsp.stereolfo~."
        }
      },
      {
        "box": {
          "id": "preset_message",
          "maxclass": "message",
          "text": "/abl.dsp.stereolfo/preset 1",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.dsp.stereolfo] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_phase",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_stereophase",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_spin",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_enablespin",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Creates stereo modulation trajectories; phase offsets move channels apart while Spin lets their rates diverge.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Frequency, Waveform, Phase, Stereo Phase, Spin, Duty",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.dsp.stereolfo~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.dsp.stereolfo~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.dsp.stereolfo~ help file."
        }
      },
      {
        "box": {
