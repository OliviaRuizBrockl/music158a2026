    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Mixes the input with very short modulated delays and feedback, producing moving comb-filter interference.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_flanger",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.dsp.flanger~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js mix:skip warmth:random feedback:random time:random",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js mix warmth feedback time",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.dsp.flanger~."
        }
      },
      {
        "box": {
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.dsp.flanger] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Creates sweeping notches, metallic motion and jet-like coloration; feedback intensifies the comb resonance.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Mix, Feedback, Time, Warmth",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.dsp.flanger~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.dsp.flanger~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.dsp.flanger~ help file."
        }
      },
      {
        "box": {
