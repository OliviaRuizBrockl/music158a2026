    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Creates independently timed stereo echoes with feedback, filtering, modulation and optional ping-pong routing.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_delay",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.device.delay~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js modtime:random modfreq:random modfilter:random smoothmode:random filter_width:random filter:random filter_frequency:random delay:random feedback:random mix:skip pingpong:random",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_filter_frequency"
                }
              },
              {
                "box": {
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js modtime modfreq modfilter smoothmode filter_width filter filter_frequency delay feedback mix pingpong",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.device.delay~."
        }
      },
      {
        "box": {
          "id": "preset_message",
          "maxclass": "message",
          "text": "/abl.device.delay/preset 1",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.device.delay] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_modfreq",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_modfilter",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_modfilter",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_smoothmode",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_smoothmode",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_filter_width",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_filter_width",
          "hidden": 1
        }
      },
      {
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_filter_frequency",
          "hidden": 1
        }
      },
      {
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Produces discrete repeats, stereo motion, comb-like coloration at short times, or continuously evolving echoes with feedback.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Mix, Delay Time, Feedback, Delay Mod, Mod Rate, Modfilter",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.device.delay~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.device.delay~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.device.delay~ help file."
        }
      },
      {
        "box": {
