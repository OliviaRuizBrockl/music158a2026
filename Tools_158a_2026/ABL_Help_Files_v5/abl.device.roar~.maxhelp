    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Routes audio through up to three saturation/shaping stages with filtering, feedback, compression and flexible modulation.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_roar",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.device.roar~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js lfo1waveform:random lfo_frequency_1:random input_gain:skip routing:random tone_amount:random tone_frequency:random shaper_amount_1:random shaper_type_1:random shaper_bias_1:random filter_frequency_1:random blend:random filter_type_1:random filter_resonance_1:random",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_lfo_frequency_1"
                }
              },
              {
                "box": {
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_tone_frequency"
                }
              },
              {
                "box": {
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_shaper_amount_1"
                }
              },
              {
                "box": {
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_filter_frequency_1"
                }
              },
              {
                "box": {
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_filter_resonance_1"
                }
              },
              {
                "box": {
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js lfo1waveform lfo_frequency_1 input_gain routing tone_amount tone_frequency shaper_amount_1 shaper_type_1 shaper_bias_1 filter_frequency_1 blend filter_type_1 filter_resonance_1",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.device.roar~."
        }
      },
      {
        "box": {
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.device.roar] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          "id": "abl_bootstrap",
          "maxclass": "newobj",
          "text": "js abl_help_bootstrap.js input:input_gain",
          "numinlets": 1,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_lfo1waveform",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_lfo_frequency_1",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_lfo_frequency_1",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_input_gain",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_routing",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_tone_amount",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_tone_amount",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_tone_frequency",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_tone_frequency",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_shaper_amount_1",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_shaper_amount_1",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_shaper_type_1",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_shaper_type_1",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_shaper_bias_1",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_shaper_bias_1",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_filter_frequency_1",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_filter_frequency_1",
          "hidden": 1
        }
      },
      {
        "box": {
          ...
          "varname": "abl_param_blend",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_filter_type_1",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_filter_type_1",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_filter_resonance_1",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_filter_resonance_1",
          "hidden": 1
        }
      },
      {
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Adds harmonics, clipping, density and animated nonlinear color, ranging from subtle warmth to aggressive multi-stage distortion.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Blend, Input Gain, Routing, Tone Amount, Tone Frequency, Shaper Amount 1",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.device.roar~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.device.roar~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.device.roar~ help file."
        }
      },
      {
        "box": {
