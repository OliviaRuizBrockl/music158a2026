    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_sub",
          "maxclass": "comment",
          "text": "Analog-style drum processor",
          "fontsize": 13,
          "fontface": 1,
          "patching_rect": [
            24,
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Combines saturation, compression, transient shaping and a tunable low-frequency resonant \u201cboom\u201d stage for drum material.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_drumbuss",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.device.drumbuss~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js boomfreq:random boom:random decay:random damping:random crunch:random transients:random compressor:random drive:random distortion:random trim:random mix:skip",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js boomfreq boom decay damping crunch transients compressor drive distortion trim mix",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.device.drumbuss~."
        }
      },
      {
        "box": {
          "id": "preset_message",
          "maxclass": "message",
          "text": "/abl.device.drumbuss/preset 1",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.device.drumbuss] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_crunch",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_transients",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_transients",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_compressor",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Adds density and glue, sharpens or softens attacks, introduces harmonic grit and can reinforce the low end with a decaying resonance.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Mix, Drive, Decay, Damping, Boom, Boom Frequency",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.device.drumbuss~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.device.drumbuss~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.device.drumbuss~ help file."
        }
      },
      {
        "box": {
