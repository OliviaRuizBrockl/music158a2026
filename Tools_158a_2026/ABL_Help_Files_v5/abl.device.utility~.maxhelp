    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Performs gain, balance, phase, channel, mid/side, mono and bass-mono operations on a stereo signal.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_utility",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.device.utility~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js invert_phase_l:random invert_phase_r:random channelmode:random mono:random midside:random audition_bass_mono:random bass_mono_frequency:random bass_mono:random balance:random gain:random",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_invert_phase_l"
                }
              },
              {
                "box": {
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_invert_phase_r"
                }
              },
              {
                "box": {
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_audition_bass_mono"
                }
              },
              {
                "box": {
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_bass_mono_frequency"
                }
              },
              {
                "box": {
              ...
              },
              {
                "box": {
                  "id": "dpm_route_6",
                  "maxclass": "newobj",
                  "text": "route bass_mono_frequency",
                  "numinlets": 1,
                  "numoutlets": 2,
                  "outlettype": [
                    "",
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js invert_phase_l invert_phase_r channelmode mono midside audition_bass_mono bass_mono_frequency bass_mono balance gain",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.device.utility~."
        }
      },
      {
        "box": {
          "id": "preset_message",
          "maxclass": "message",
          "text": "/abl.device.utility/preset 1",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.device.utility] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_invert_phase_l",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_invert_phase_r",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_invert_phase_r",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_channelmode",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_midside",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_audition_bass_mono",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_audition_bass_mono",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_bass_mono_frequency",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_bass_mono_frequency",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_bass_mono",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Changes level and stereo geometry without adding an intentional effect tail; useful for image control, phase correction and low-end mono compatibility.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Gain, Balance, Channel Mode, Invert L, Invert R, Mono",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.device.utility~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.device.utility~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.device.utility~ help file."
        }
      },
      {
        "box": {
