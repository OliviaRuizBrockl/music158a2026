    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Generates a plate-like reverberant field, creating pseudo-stereo ambience from the input.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_reverb",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.device.reverb~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js decay:random predelay:random mix:skip damping:random",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js decay predelay mix damping",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.device.reverb~."
        }
      },
      {
        "box": {
          "id": "preset_message",
          "maxclass": "message",
          "text": "/abl.device.reverb/preset 1",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.device.reverb] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Adds a diffuse tail and sense of space; predelay separates the source from the tail while damping darkens the decay.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Mix, Decay, Damping, Predelay",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.device.reverb~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.device.reverb~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.device.reverb~ help file."
        }
      },
      {
        "box": {
