    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_sub",
          "maxclass": "comment",
          "text": "Modulated multimode filter",
          "fontsize": 13,
          "fontface": 1,
          "patching_rect": [
            24,
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Filters incoming audio with resonant filter models that can be animated by envelope, LFO and sidechain-derived modulation.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_autofilter",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.device.autofilter~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js internalscgain:random sclisten:random scresonance:random sceqtype:random sceq:random scfrequency:random envrelease:random envhold:random envattack:random envamount:random scmono:random lfophaseoffset:random lfosmoothing:random lfowaveform:random lfoquantize:random lfostereo:random lfophase:random lfospin:random lforate:random lfoamount:random lfomorph:random lfosteps:random vowelformant:random vowelpitch:random djcontrol:random frequency:random drive:random resonance:random filtertype:random",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_internalscgain"
                }
              },
              {
                "box": {
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_lfophaseoffset"
                }
              },
              {
                "box": {
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js internalscgain sclisten scresonance sceqtype sceq scfrequency envrelease envhold envattack envamount scmono lfophaseoffset lfosmoothing lfowaveform lfoquantize lfostereo lfophase lfospin lforate lfoamount lfomorph lfosteps vowelformant vowelpitch djcontrol frequency drive resonance filtertype",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.device.autofilter~."
        }
      },
      {
        "box": {
          "id": "preset_message",
          "maxclass": "message",
          "text": "/abl.device.autofilter/preset 1",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.device.autofilter] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_internalscgain",
          "hidden": 1
        }
      },
      {
        "box": {
          ...
          "varname": "abl_param_sclisten",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_scresonance",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_sceq",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_scfrequency",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_scfrequency",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_envrelease",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_envhold",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_envattack",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_envattack",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_envamount",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_scmono",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_lfophaseoffset",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_lfophaseoffset",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_lfosmoothing",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_lfosmoothing",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_lfowaveform",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_lfowaveform",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_lfoquantize",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_lfoquantize",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_lfostereo",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_lforate",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_lfoamount",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_lfosteps",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_vowelformant",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_vowelformant",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_vowelpitch",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_vowelpitch",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_djcontrol",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Creates moving spectral emphasis, sweeps and resonant coloration that can follow the dynamics of the source.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Frequency, Filter Type, Resonance, Drive, Envelope Amount, Internalscgain",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.device.autofilter~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.device.autofilter~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.device.autofilter~ help file."
        }
      },
      {
        "box": {
