    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Creates a dense algorithmic reverb with diffusion, modulation, damping and distance controls.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_quartz",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.dsp.quartz~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js freeze:random low_damping:random damping:random size:random distance:random diffusion:random decay:random mix:skip mod:random",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js freeze low_damping damping size distance diffusion decay mix mod",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.dsp.quartz~."
        }
      },
      {
        "box": {
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.dsp.quartz] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_distance",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_diffusion",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Ranges from sparse reflective ambience to smooth dense tails; modulation adds movement and damping progressively darkens the space.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Mix, Mod Depth, Decay, Size, Damping, Diffusion",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.dsp.quartz~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.dsp.quartz~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.dsp.quartz~ help file."
        }
      },
      {
        "box": {
