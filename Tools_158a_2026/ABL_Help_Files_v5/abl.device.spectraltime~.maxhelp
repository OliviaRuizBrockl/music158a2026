    ...
    "boxes": [
      ...
      },
      {
        "box": {
          "id": "hdr_sub",
          "maxclass": "comment",
          "text": "Spectral freeze and delay",
          "fontsize": 13,
          "fontface": 1,
          "patching_rect": [
            24,
      ...
      },
      {
        "box": {
          "id": "hdr_desc",
          "maxclass": "comment",
          "text": "Freezes and delays spectral frames, then shifts, sprays and feeds them back independently of the original time-domain signal.",
          "fontsize": 11,
          "patching_rect": [
            24,
            76,
      ...
      },
      {
        "box": {
          ...
          "hint": "External signal input: send~ ABL_spectraltime",
          "id": "ext_receive",
          "maxclass": "newobj",
          "numinlets": 1,
          "numoutlets": 1,
            ...
            "boxes": [
              {
                "box": {
                  "id": "dpm_title",
                  "maxclass": "comment",
                  "text": "abl.device.spectraltime~ \u2014 Direct_Parameter_Messaging / Dynamic Tuning",
                  "fontsize": 18,
                  "fontface": 1,
                  "patching_rect": [
                    24,
              ...
              },
              {
                "box": {
                  "id": "dpm_js",
                  "maxclass": "newobj",
                  "text": "js abl_help_randomizer.js fade_in:random crossfade_pct:random fade_out:random retrig_mode:random fade:random time_sync_interval:random spread:random delay_mix:skip delay_time:random feedback:random shift:random spray:random tilt:random mask:random freeze:random sensitivity:random freeze_mode:random mix:skip",
                  "numinlets": 1,
                  "numoutlets": 1,
                  "outlettype": [
                    ""
              ...
              },
              {
                "box": {
                  ...
                  "varname": "display_time_sync_interval"
                }
              },
              {
                "box": {
      ...
      },
      {
        "box": {
          "id": "capture_js",
          "maxclass": "newobj",
          "text": "js abl_help_state_capture.js fade_in crossfade_pct fade_out retrig_mode fade time_sync_interval spread delay_mix delay_time feedback shift spray tilt mask freeze sensitivity freeze_mode mix",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
            "",
      ...
      },
      {
        "box": {
          ...
          "hint": "External preset recall receive for abl.device.spectraltime~."
        }
      },
      {
        "box": {
          "id": "preset_message",
          "maxclass": "message",
          "text": "/abl.device.spectraltime/preset 1",
          "numinlets": 2,
          "numoutlets": 1,
          "outlettype": [
            ""
          ...
          "hint": "Editable preset recall. Send the same message to [s abl.device.spectraltime] for external control."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          "id": "abl_bootstrap",
          "maxclass": "newobj",
          "text": "js abl_help_bootstrap.js wet:delay_mix wet:mix",
          "numinlets": 1,
          "numoutlets": 1,
          "outlettype": [
            ""
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_fade_in",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_crossfade_pct",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_crossfade_pct",
          "hidden": 1
        }
      },
      {
        "box": {
          ...
          "varname": "abl_param_fade_out",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_retrig_mode",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_fade",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_time_sync_interval",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_time_sync_interval",
          "hidden": 1
        }
      },
      {
        "box": {
          ...
          "varname": "abl_param_spread",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_delay_mix",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_delay_mix",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_delay_time",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          ...
          "varname": "abl_param_freeze",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_sensitivity",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
          ...
          "varname": "abl_param_sensitivity",
          "hidden": 1
        }
      },
      {
        "box": {
          "id": "abl_ctl_freeze_mode",
          "maxclass": "live.numbox",
          "numinlets": 1,
          "numoutlets": 2,
          "outlettype": [
      ...
      },
      {
        "box": {
          "id": "doc_signal",
          "maxclass": "comment",
          "text": "Produces suspended spectra, smeared echoes, frozen timbres and pitch-shifted spectral clouds.",
          "fontsize": 11,
          "patching_rect": [
            24,
            395,
      ...
      },
      {
        "box": {
          "id": "doc_params",
          "maxclass": "comment",
          "text": "KEY CONTROLS: Mix, Feedback, Freeze, Spread, Fade In, Crossfade Pct",
          "fontsize": 11,
          "patching_rect": [
            24,
            435,
      ...
      },
      {
        "box": {
          ...
          "hint": "Click to open the original Max 9 Ableton DSP help file for abl.device.spectraltime~."
        }
      },
      {
        "box": {
      ...
      },
      {
        "box": {
          ...
          "text": "\"Package:/Ableton DSP/help/abl.device.spectraltime~.maxhelp\"",
          "hidden": 1,
          "hint": "Exact portable Max package path for the original abl.device.spectraltime~ help file."
        }
      },
      {
        "box": {
