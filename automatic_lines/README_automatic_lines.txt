AUTOMATIC LINES FOR MAX 9
=========================

Files
-----
automatic_lines.js       JavaScript object
automatic_lines.maxhelp  Interactive Max help patch
...
Create the object with three arguments:
    ...
    js automatic_lines.js <voices> <minimum_ms> <wait_ms> <maximum_ms>

Example:

    js automatic_lines.js 4 500 1000 2000
...
Open automatic_lines.maxhelp for a working four-voice example.
